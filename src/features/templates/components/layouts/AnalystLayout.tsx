...
import { Page, Text, View, Image, Link, Svg, Path } from '@react-pdf/renderer';
import { ResumeData } from '@/types';
import { styles } from './AnalystLayout.styles';

interface LayoutProps {
    data: ResumeData;
}

const AnalystLayout: React.FC<LayoutProps> = ({ data }) => {
            ...
            <View style={styles.sidebar}>
                ...
                {skills && skills.length > 0 && (
                    <View style={styles.sidebarSection}>
                        ...
                        {skills.map((skill, i) => (
                            <View key={`skill-${i}`} style={styles.skillItem}>
            ...
            <View style={styles.main}>
                ...
                {experience && experience.length > 0 && (
                    <View style={styles.section}>
                        ...
                        {experience.map((exp, i) => (
                            <View key={exp.id || i} style={{ marginBottom: 14 }}>
                ...
                {projects && projects.length > 0 && (
                    <View style={styles.section}>
                        ...
                        {projects.map((proj, i) => (
                            <View key={proj.id || i} style={{ marginBottom: 14 }}>
                                <View style={styles.itemHeader}>
                ...
                {achievements && achievements.length > 0 && (
                    <View style={styles.section}>
                        ...
                        {achievements.map((ach, i) => (
                            <View key={ach.id || i} style={{ marginBottom: 14 }}>
                                <Text style={[styles.itemBold, { marginBottom: 4 }]}>{ach.title}</Text>
