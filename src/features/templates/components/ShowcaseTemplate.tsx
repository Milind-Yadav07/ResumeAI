...
const ShowcaseTemplate: React.FC<TemplateProps> = ({ data }) => {
        ...
        <div className="w-[189mm] p-[10pt] text-black leading-normal bg-transparent relative z-10 box-border font-serif">
            ...
            {experience && experience.length > 0 && (
                <section className="mb-[20pt] last:mb-0">
                    ...
                    {experience.map((exp, i) => (
                        <div key={exp.id || i} className="mb-[18pt] pl-[20pt] last:mb-0">
            ...
            {projects && projects.length > 0 && (
                <section className="mb-[20pt] last:mb-0">
                    ...
                    {projects.map((proj, i) => (
                        <div key={proj.id || i} className="mb-[18pt] pl-[20pt] last:mb-0">
                            <div className="flex justify-between items-baseline text-[11.5pt] font-extrabold text-black mb-[3pt]">
            ...
            {education && education.length > 0 && (
                <section className="mb-[20pt] last:mb-0">
                    ...
                    {education.map((edu, i) => (
                        <div key={edu.id || i} className="mb-[18pt] pl-[20pt] last:mb-0">
                            <div className="flex justify-between items-baseline text-[11.5pt] font-extrabold text-black mb-[3pt]">
            ...
            {achievements && achievements.length > 0 && (
                <section className="mb-[20pt] last:mb-0">
                    ...
                    {achievements.map((ach, i) => (
                        <div key={ach.id || i} className="mb-[18pt] pl-[20pt] last:mb-0">
                            <div className="flex justify-between items-baseline text-[11.5pt] font-extrabold text-black mb-[3pt]">
                                <span>{ach.title}</span>
                            </div>
