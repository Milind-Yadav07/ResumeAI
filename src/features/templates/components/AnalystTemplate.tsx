...
const AnalystTemplate: React.FC<TemplateProps> = ({ data }) => {
                ...
                <div className="flex flex-col">
                    ...
                    {education && education.length > 0 && (
                        <div className="mb-[22pt]">
                            ...
                            {education.map((edu, i) => (
                                <div key={edu.id || i} className="mb-[12pt]">
            ...
            <div className="p-[0.5in] bg-transparent z-10">
                ...
                {experience && experience.length > 0 && (
                    <section className="mb-[20pt]">
                        ...
                        {experience.map((exp, i) => (
                            <div key={exp.id || i} className="mb-[14pt]">
                ...
                {projects && projects.length > 0 && (
                    <section className="mb-[20pt]">
                        ...
                        {projects.map((proj, i) => (
                            <div key={proj.id || i} className="mb-[14pt]">
                                <div className="flex justify-between items-baseline text-[11pt] mb-[3pt]">
                ...
                {achievements && achievements.length > 0 && (
                    <section className="mb-[20pt]">
                        ...
                        {achievements.map((ach, i) => (
                            <div key={ach.id || i} className="mb-[14pt]">
