        ...
        <div className="p-[0.5in] text-[#111827] leading-normal min-h-full bg-transparent font-serif relative z-10">
            ...
            {experience && experience.length > 0 && (
                <section className="mb-[16pt] last:mb-0">
                    ...
                    {experience.map((exp, i) => (
                        <div key={exp.id || i} className="mb-[16pt] last:mb-0">
            ...
            {projects && projects.length > 0 && (
                <section className="mb-[16pt] last:mb-0">
                    ...
                    {projects.map((proj, i) => (
                        <div key={proj.id || i} className="mb-[16pt] last:mb-0">
                            <div className="flex justify-between items-baseline text-[11pt] mb-[3pt]">
            ...
            {education && education.length > 0 && (
                <section className="mb-[16pt] last:mb-0">
                    ...
                    {education.map((edu, i) => (
                        <div key={edu.id || i} className="mb-[16pt] last:mb-0">
                            <div className="flex justify-between items-baseline text-[11pt] mb-[3pt]">
            ...
            {achievements && achievements.length > 0 && (
                <section className="mb-[16pt] last:mb-0">
                    ...
                    {achievements.map((ach, i) => (
                        <div key={ach.id || i} className="mb-[16pt] last:mb-0">
                            <div className="flex justify-between items-baseline text-[11pt] mb-[3pt]">
